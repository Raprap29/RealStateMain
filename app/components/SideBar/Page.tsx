  ...
  return (
    <React.Fragment>
      {isOpen && (
        ...
        className={`overflow-y-scroll fixed left-0 top-0 h-screen transition-all duration-300 ease-in-out z-[9999] w-[70%] bg-gray-200 left-[-300px]`}>
            ...
            <div className="items-center">
              <ul className="list-none flex flex-col justify-center items-center">
                {/* <div className="max-[620px]:block hidden absolute top-[50%] left-[50%] transform translate-x-[-50%] translate-y-[-50%]"><Image src="/logo/LogoJama.png" width={Phone ? 120 : 170} alt="logo" height={Phone ? 120 : 170} /></div> */}
                  ...
                  <li className={`nav-item`}>
                    <Link onClick={handleCloseNavBar} className="px-3 py-7 flex items-center text-xs uppercase font-bold leading-snug text-black hover:opacity-75" href="/list-my-property">
                      <div className="w-full relative">
