    ...
    <React.Fragment>
      <div className="bg-[#FFFFFF] h-[100px] z-70 flex items-center justify-between mx-auto container max-w-[1240px]">
        ...
        <div className="flex justify-center items-center gap-x-[50px]">
          <div className="max-[620px]:mr-[30px]"><Image src="/icon/ExploreLocation.png" width={Phone ? 60 : 80} height={Phone ? 60 : 80} alt="Icon" /></div>
      ...
      {ToggleMenu && <Sidebar isOpen={ToggleMenu} />}
    </React.Fragment>
  );
};
